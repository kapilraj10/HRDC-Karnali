...
const HRDCFooter = () => {
  return (
    <footer className="bg-white text-dark pt-4">
      {/* Main Footer Content */}
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            ...
            <div className="social-icons mt-3">
              <a href="https://facebook.com/hrdckarnali" className="text-dark me-2" target="_blank" rel="noopener noreferrer">
                <FaFacebook size={20} />
              </a>
              <a href="https://twitter.com/hrdckarnali" className="text-dark me-2" target="_blank" rel="noopener noreferrer">
                <FaTwitter size={20} />
              </a>
              <a href="https://instagram.com/hrdckarnali" className="text-dark me-2" target="_blank" rel="noopener noreferrer">
                <FaInstagram size={20} />
              </a>
              <a href="https://linkedin.com/company/hrdc-karnali" className="text-dark me-2" target="_blank" rel="noopener noreferrer">
                <FaLinkedin size={20} />
              </a>
            </div>
          </div>
